...
{{marginnote: Reading Bayle's Dictionary was the 18th-century equivalent of playing an open-world video game where you ignore the main quest. The biographical entry is the boring tutorial: "Go fetch three facts about Epicurus." But then you click on footnote and suddenly you're on a 10,000-word side-quest about whether a god who allows evil can be considered good, unlocking the secret 'Radical Doubt' achievement. You’d go in looking for a date and come out three days later questioning the fabric of reality.}}
